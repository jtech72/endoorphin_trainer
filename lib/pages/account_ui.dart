...
class AccountUI extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     appBar: myAppBar(title:Text('Accounts',style: Theme.of(context).textTheme.bodyMedium,), context: context, ),
      body: Container(
        height: Get.height,
        width: Get.width,
        ...
        child: SingleChildScrollView(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Center(
                child: InkButton(
                    child: Text('Update',style: Theme.of(context).textTheme.headlineSmall!.copyWith(color: AppColors.black,fontSize: 20,fontWeight: FontWeight.w500),),
                    onTap: (){}),
              ),
            ],
