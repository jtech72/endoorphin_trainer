                  ...
                  return  Center(
                    child:                   Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Center(child: Text(
                          snapshot.data!.result == null ?"":
                          "${snapshot.data!.result!.userName} ${snapshot.data!.result!.lastName} ",style: Theme.of(context).textTheme.headlineSmall!.copyWith(color: AppColors.white),)),
                        SizedBox(
                        ...
                        Center(child: Text(
                            ...
                            "${snapshot.data!.result!.email} ",style: Theme.of(context).textTheme.labelMedium!.copyWith(fontWeight: FontWeight.w500,color: AppColors.white))),
                        SizedBox(
                          height: Get.height*0.003,
                        ),
