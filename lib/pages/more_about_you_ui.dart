...
class MoreAboutYouUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // appBar: AppBar(title: Text('Endorphine',style: TextStyle(color: AppColors.white),),leading: Icon(Icons.arrow_back_ios,size: 18,color: AppColors.white,),centerTitle: false,),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Transform.translate(offset: Offset(0,-3),child: Image.asset(ImagesPaths.logoimg,height: 36,width: 146,)),
                    ],
